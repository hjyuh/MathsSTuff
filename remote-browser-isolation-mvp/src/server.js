...
const config = {
  ...
  prepullWorkspaceImage: parseBoolean(process.env.RBI_PREPULL_WORKSPACE_IMAGE, true),
  imagePullTimeoutMs: Number(process.env.RBI_IMAGE_PULL_TIMEOUT_MINUTES ?? 15) * 60 * 1000,
...
const sessionManager = new SessionManager({
  ...
  prepullWorkspaceImage: config.prepullWorkspaceImage,
  imagePullTimeoutMs: config.imagePullTimeoutMs,
